...
namespace VideoGameDBServiceTests.IntegrationTests
{
    ...
    public class GameIntegrationTests
    {
        ...
        public void IntegrationTestGames_GetAll()
        {
            ...
            var content = JsonConvert.DeserializeObject<List<Games>>(response.Content.ReadAsStringAsync().Result);
        ...
        public void IntegrationTestGames_GetSingle()
        {
            ...
            //Act
            var response = _client.SendAsync(request).Result;
            var content = JsonConvert.DeserializeObject<Games>(response.Content.ReadAsStringAsync().Result);
